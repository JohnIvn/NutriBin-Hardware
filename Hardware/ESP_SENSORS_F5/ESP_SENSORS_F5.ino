...
// ================= CONFIG VARIABLES =================
String WIFI_SSID_1     = "ZTE_2.4G_emHexQ";
String WIFI_PASSWORD_1 = "ex3pFTqm";
...
String USER_ID    = "57b9ff77-7c99-4b08-9d90-239aed1a78a4";
String MACHINE_ID = "5537105f-d4cf-4fdd-b5a8-dc6d1e44fdfb";
String BACKEND_URL        = "https://nutribin-server-backend-production.up.railway.app/hardware/sensor-data";
String BACKEND_STATUS_URL = "https://nutribin-server-backend-production.up.railway.app/hardware/sensor-status";
...
bool uploadSensorStatus() {
  ...
  Serial.println("Status payload (not sent yet): " + payload);
  return true;
}
